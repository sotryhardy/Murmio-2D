...
public class Player : MonoBehaviour
{
    ...
    Vector3 CheckWallRay(Vector3 pos, float direction)
    {
    ...
    Vector3 CheckFloorRays(Vector3 pos)
    {
        ...
        if (floorLeft.collider || floorMiddle.collider || floorRight.collider)
        {
    ...
    Vector3 CheckCeilingRays(Vector3 pos)
    {
        ...
        if(ceilLeft.collider || ceilMiddle.collider || ceilRight.collider)
        {
            ...
            pos.y = hitRay.collider.bounds.center.y + hitRay.collider.bounds.size.y / 2 - 2;
